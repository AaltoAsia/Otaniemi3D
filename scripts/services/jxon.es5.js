 ...
 */
angular.module('otaniemi3dApp').service('JXON', function () {
  ...
  Element.prototype.appendJXON = function (oObjTree) {
    var oParentEl = document.createElementNS(this.namespaceURI, this.nodeName);
  ...
  this.createXML = function (oObjTree, sNamespaceURI, sQualifiedName, oDocumentType) {
