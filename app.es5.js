 ...
 */
angular.module('otaniemi3dApp', ['ui.bootstrap', 'ui.grid', 'ui.router', 'angular-loading-bar', 'highcharts-ng']).config(function ($stateProvider, $urlRouterProvider, $urlMatcherFactoryProvider) {
